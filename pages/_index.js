              ...
              {thumbnails.map((image, index) => (
                ...
                >
                  ...
                  {dragging && Number(draggedIndex) === Number(image.id) && (
                    <div className="absolute top-0 left-0 h-full w-full flex justify-center items-center bg-white border-2 rounded-lg"></div>
                  )}
                </div>
              ))}
              <div className="relative border-2 rounded-lg p-4 hover:bg-gray-50 transition-colors ease-linear">
                <input
                  type="file"
                  multiple
                  name="images"
